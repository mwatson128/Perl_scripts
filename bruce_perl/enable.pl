...
#   $exp->send("/usr/sbin/svcadm enable megw-3-ud-prod\n");
#   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable megw-2-ud-prod\n");
   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable megw-1-ud-prod\n");
   $exp->expect(10, '-re', qr'.*[$>#] $' );

#   $exp->send("/usr/sbin/svcadm enable uswgw-3-ud-prod\n");
#   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable uswgw-2-ud-prod\n");
   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable uswgw-1-ud-prod\n");
   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable s1mq-ud-prod\n");
   $exp->expect(30, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable $server\_node_agent-2\n");
   $exp->expect(10, '-re', qr'.*[$>#] $' );

   $exp->send("/usr/sbin/svcadm enable $server\_node_agent-1\n");
   $exp->expect(20, '-re', qr'.*[$>#] $' );
