#!/bin/perl
###########################################################################
# month_rerun.pl - Script for month end billing for Ultraswitch. 1.3
# (]$[) month_rerun.pl:1.3 | CDATE=11/29/06 14:44:55
###########################################################################
#
...
$ENV{PATH} = ".:/$zone/usw/offln/bin:/bin:/usr/bin:/usr/.ucbucb:/usr/local/bin:/usr/ucb:/$zone/$zone/usw/reports/monthly/bin:/pdl/bin:/home/uswrpt/teTeX/bin/sparc-solaris2.5/";
