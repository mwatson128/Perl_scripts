#!/bin/perl
#*TITLE - prod_offln.pl - Perl script to run daily offline processes - 1.9
#*SUBTTL Preface, and environment 
#
#  (]$[) prod_offln.pl:1.9 | CDATE=08:50:51 11/30/06
#
#
...

{
  ...
  setenv("lgrpt_codir", "/$zone/loghist/co");
  setenv("lgrpt_dir", "/$zone/loghist/rpt");
  setenv("lgrej_dir", "/$zone/loghist/rej");
  setenv("lgper_dir", "/$zone/loghist/per");
  setenv("qcheck_dir", "/$zone/loghist/qdata");
