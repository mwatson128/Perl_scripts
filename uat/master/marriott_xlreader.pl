...
@fields = qw(2 5 8 11 14 17 20 23 26 29 32 35 38
             41 44 47 50 53);
#@fields = qw(3 6 9 12 15 18 21);
#@fields = qw(8 20);
@prevNames = qw(2 6 10 14 18 22 26 30 34 38 42 46 50 54 58);
...
%fieldNames = (
  ...
  35 => "ASSESSMENT FEE",
  38 => "NON REFUNDABLE PET SANITATION FEE",
  41 => "REFUNDABLE PET SANITATION FEE",
  44 => "STATE COST RECOVERY FEE",
  47 => "DESTINATION AMENITY FEE",
  50 => "HOTEL - MOTEL FEE",
  53 => "LOCAL FEE",
);
