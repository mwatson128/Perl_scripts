...
sub lgrpt_vtally 
{
  ...
  if ($rtn_val = system("purge -d ${database_a} -t ${date} -n dvol_tbl -f ddate >> $logfile 2>> $logfile")) {
  ...
  if ($rtn_val = system("dvoltal -d ${database_a} -l ${lgrptvol_file} >> $logfile 2>> $logfile")) {
...
sub lgrpt_dtally 
{
  ...
  if ($rtn_val = system("expire -d ${database_a} -t ${edate} -n hour_tbl >> $logfile 2>> $logfile")) {
  ...
  if ($rtn_val = system("purge -d ${database_a} -t ${date} -n hour_tbl -f ddate >> $logfile 2>> $logfile")) {
  ...
  if ($rtn_val = system("dtally -d ${database_a} -t ${date} -W ${dtally_interfile} >> $logfile 2>> $logfile")) {
  ...
  if ($rtn_val = system("dtally -d ${database_a} -t ${date} -R ${dtally_interfile} >> $logfile 2>> $logfile")) {
...
sub lgrpt_mtally 
{
  ...
  if ($rtn_val = system("purge -d ${database_a} -t ${date} -n day_tbl -f ddate >> $logfile 2>> $logfile")) {
  ...
  if ($rtn_val = system("mtally -d ${database_a} -t ${date} >> $logfile 2>> $logfile")) {
