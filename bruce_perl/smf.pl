...
#   $exp->expect(10, '-re', qr'[$>#] $' );
#   $exp->send("/usr/sbin/svcadm enable /application/SUNWappserver/$server\_node_agent-1\n");
#   $exp->expect(50, '-re', qr'[$>#] $' );
#   $exp->send("/usr/sbin/svcadm enable /application/SUNWappserver/$server\_node_agent-2\n");
#   $exp->expect(50, '-re', qr'[$>#] $' );
#   $exp->send("/usr/sbin/svcadm enable /application/s1mq-ud-prod\n");
#   $exp->expect(50, '-re', qr'[$>#] $' );
