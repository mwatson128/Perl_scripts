#!/usr/local/bin/perl
# (]$[) daycttm.pl:1.2 | CDATE=06/03/02 09:47:54
######################################################################
...
##############################################
$tologfile = "/usw/reports/daily/tologs/" . $month . $tdyear . "/tolog" . $day;
$tologdir = "/usw/reports/daily/tologs/summary";
$master_config = "/usw/src/scripts/prod/all/config/master.cfg";
$config_file = "/usw/offln/bin/daycttm.cfg";
